...
<tr><td style="padding:28px 32px 0 32px;"><div style="${mono}font-size:11px;color:${grey};">WHERE THE BIG IDEA COMES FROM · DROP 01 · 24 HOURS EARLY</div><div style="${display}font-size:44px;line-height:1.02;color:#fff;margin-top:10px;">${drop.title.toUpperCase()}<span style="color:${acid};">.</span></div></td></tr>
